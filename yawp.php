 ...
 * Description: Yet Another WordPress (Backup) Plugin — incremental S3 backups.
 * Version: 1.15.0
 * Author: Nonatech UK
 * License: GPLv2 or later
 * Update URI: https://github.com/nonatech-uk/yawp
 * Requires PHP: 7.4
 */
...
function yawp_log( $level, $message, $context = [] ) {
    if ( function_exists( 'loki_send_log' ) ) {
        $context['plugin']  = 'yawp';
        $context['version'] = YAWP_VERSION;
...
register_deactivation_hook( __FILE__, function () {
    ...
    wp_clear_scheduled_hook( 'yawp_backup_step' );
});
